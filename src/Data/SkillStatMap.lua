...
["spell_base_necrotic_damage"] = { skill("NecroticDamage", nil) },
["spell_base_void_damage"] = { skill("VoidDamage", nil) },
["spell_base_physical_damage"] = { skill("PhysicalDamage", nil) },
["melee_base_fire_damage"] = { skill("FireDamage", nil) },
["melee_base_cold_damage"] = { skill("ColdDamage", nil) },
["melee_base_lightning_damage"] = { skill("LightningDamage", nil) },
["melee_base_necrotic_damage"] = { skill("NecroticDamage", nil) },
["melee_base_void_damage"] = { skill("VoidDamage", nil) },
["melee_base_physical_damage"] = { skill("PhysicalDamage", nil) },
["melee_base_poison_damage"] = { skill("PoisonDamage", nil) },
["bow_base_lightning_damage"] = { skill("LightningDamage", nil) },
["bow_base_physical_damage"] = { skill("PhysicalDamage", nil) },
["throwing_base_fire_damage"] = { skill("FireDamage", nil) },
["throwing_base_physical_damage"] = { skill("PhysicalDamage", nil) },
["None_base_fire_damage"] = { skill("FireDamage", nil) },

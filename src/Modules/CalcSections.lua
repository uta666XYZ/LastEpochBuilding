...
{ 1, "Armour", 3, colorCodes.ARMOUR, {{ defaultCollapsed = false, label = "Armor", data = {
	...
	{ label = "Armor Mitigation", haveOutput = "RawArmourDefense", { format = "{0:output:RawArmourDefense}%", { modName = "ArmourDefense" }, }, },
	...
	{ label = "Elem. Dmg. Reduct", haveOutput = "ArmorMitigationElemental", { format = "{0:output:ArmorMitigationElemental}%",

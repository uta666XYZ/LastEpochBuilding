-- Dump PoisonResist modDB entries for triangulation vs LETools.
...
print("Build:", path)
print("=========================================")
print(string.format("output.PoisonResist        = %s", tostring(output.PoisonResist)))
print(string.format("output.PoisonResistTotal   = %s", tostring(output.PoisonResistTotal)))
print(string.format("output.PoisonResistOverCap = %s", tostring(output.PoisonResistOverCap)))
print(string.format("output.PoisonResistMax     = %s", tostring(output.PoisonResistMax)))
print(string.format("output.HolyAuraEffect      = %s", tostring(output.HolyAuraEffect)))
print()
for _, key in ipairs({"PoisonResist","PoisonResistMax","HolyAuraEffect"}) do

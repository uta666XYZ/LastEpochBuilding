-- Dump ManaRegen modDB entries for triangulation vs LETools.
...
print("Build:", path)
print("=========================================")
print(string.format("output.ManaRegen = %s", tostring(output.ManaRegen)))
print(string.format("output.ManaRegenPercent = %s", tostring(output.ManaRegenPercent)))
print(string.format("output.Mana = %s", tostring(output.Mana)))
print()
for _, key in ipairs({"ManaRegen","ManaRegenPercent","Mana","ManaRegenBase"}) do
